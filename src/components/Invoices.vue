<template>
  ...
  <div class="page-content container" style="width: 21cm; height: 29.7cm;">
    <div class="page-header text-blue-d2 no-print">
      ...
      <div class="page-tools">
        <a type="button" class="btn btn-outline-primary btn-light mx-1px text-95" ref="content" data-title="PDF"
          @click="printInvoice">
          ...
          <div id="invoice-section" class="row align-item d-flex">
            <div class="col-8 mt-3">
              ...
              <div v-if="customerData">
                <span class="text-sm text-dark-m2 align-middle date-element">{{ customerData ? customerData.name :
                  'Loading...'
                }}</span>&nbsp;
                <span class="text-sm text-dark-m2 align-middle date-element">{{ customerData ? customerData.surname :
                  'Loading...'
                }}</span>
            ...
            <div class="col-4">
              ...
              <div class="text-dark-m2 text-sm my-3">
                ...
                <div class="my-1 d-flex justify-content-between">
                  ...
                  <div class="text-end date-element" v-if="invoiceData">{{ new Date(invoiceData.invoice_date).getDate()
                  }}.{{ new Date(invoiceData.invoice_date).getMonth() + 1 }}.{{ new
  Date(invoiceData.invoice_date).getFullYear() }}</div>
                </div>
                <div class="my-1 d-flex justify-content-between">
                ...
                <div class="my-1 d-flex justify-content-between">
                  ...
                  <div class="text-end  text-end date-element" v-if="companyData">{{ companyData ? companyData.mwst :
                    'Loading...' }}
                  </div>
                </div>
              </div>
          ...
          <div class="my-1 mt-0 pt-5 date-element" v-if="invoiceData">
            ...
            <b class="text-600 date-element mt-2">Rechnung-Nr.</b><b class="text-600 ms-3">{{ invoiceData.invoice_number
            }}</b>
          </div>
          <div class="col-sm-12">
  ...
  <p class="fw-bold text-end"><u class="double-underline">{{ finalCalculation }}</u></p>
            ...
            <div class="col-sm-12 donwpart mt-5">
              <div class="row">
                ...
                <div class="col-3 text-start" v-if="invoiceData">
                  <p class="fw-bold mb-0">{{ new Date(invoiceData.invoice_date).getDate() }}.{{ new
                    Date(invoiceData.invoice_date).getMonth() + 1 }}.{{ new Date(invoiceData.invoice_date).getFullYear()
  }} + 30 Tage</p>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-4  mt-3 mb-4 adress justify-content-end date-element">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6 text-sm text-dark text-end">{{ companyData ? companyData.webpage : 'Loading...' }}
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-6 text-sm text-start text-dark">E-Mail:</div>
                    <div class="col-6 text-sm text-dark text-end">{{ companyData ? companyData.email : 'Loading...' }}
                    </div>
                  </div>
...
.invoice-page {
  page-break-before: auto; /* Ensure a new page before each invoice */
  page-break-inside: avoid; /* Avoid breaking the invoice content inside a page */
  page-break-after: always; /* Ensure a new page after each invoice */
}



/* Add CSS to create double underlines */
.double-underline {
  position: relative;
...
.double-underline::after {
  content: "";
  position: absolute;
  bottom: -2px; /* Adjust the distance of the double underline from the text */
  left: 0;
  width: 100%;
  height: 2px;
  border-bottom: 1px solid #000; /* Adjust the style and color of the double underline */
  border-top: 1px solid #000; /* Add a top border to create a double underline effect */
}
