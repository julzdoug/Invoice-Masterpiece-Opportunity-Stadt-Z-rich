    ...
    <div class="container-fluid bg-light">
      ...
      <div class="collapse navbar-collapse bg-light custom-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-4">
          <li class="nav-item">
            <button type="button" class="btn" @click="handleMenuClick('Me')">Startseite</button>
          </li>
        </ul>
      ...
      <div class="row align-items-center justify-content-center
        ...
        <div class="col-12 col-md-8 col-lg-4">
          <div class="card shadow-sm">
            <div class="card-body">
              <div class="mb-4">
                <h5>Bitte Schreiben sie mir <br>um das Konto zu löschen</h5>
                <h5>Email: jschwarzzh@hotmail.com</h5>
                <p class="mb-2">Danach wird der account in 24h Stunden gelöscht.<br>Vielen Dank das sie Zachnung benutzt haben.
                </p>
              </div>
  
                <button type="button" class="btn text-primary" @click="handleMenuClick('Me')">Zurück</button>
